...
import { Lock, Server, Users, FileText, Image, Activity } from "lucide-react";
import { 
  CodeBlock, 
  EndpointCard, 
  HistoryContext, 
...
const ApiDocs = () => {
  ...
  "data": {
    ...
    "count": 1
                      ...
                      example={`curl -X GET "${BASE_URL}/users" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X GET "${BASE_URL}/users/user-uuid-here" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X PATCH "${BASE_URL}/users/user-uuid" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{"status": "verified", "trust_score": 75}'`}
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/users/roles" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  ...
  "data": {
    ...
    "stats": {
      ...
      "archived": 5
                      ...
                      example={`curl -X GET "${BASE_URL}/content/articles?status=draft&limit=10" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X GET "${BASE_URL}/content/articles/article-uuid" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/content/articles" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{
    ...
    "author_pseudonym": "Underground Reporter"
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/content/articles/publish" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{"article_id": "article-uuid"}'`}
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/content/articles/unpublish" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{"article_id": "article-uuid"}'`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/content/articles/bulk" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{
    "action": "publish",
  ...
  "data": {
    ...
    "count": 2
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X DELETE "${BASE_URL}/content/articles/article-uuid" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                  </ScrollArea>
                </TabsContent>
  ...
  "data": {
    ...
    "total": 100
                      ...
                      example={`curl -X GET "${BASE_URL}/content/dj-artists?search=mills&limit=10" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X GET "${BASE_URL}/content/dj-artists/1" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/content/dj-artists" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{
    ...
    "nationality": "Germany"
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X PATCH "${BASE_URL}/content/dj-artists/1" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{"nationality": "USA"}'`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/content/dj-artists/bulk" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{"action": "delete", "artist_ids": [101, 102]}'`}
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X DELETE "${BASE_URL}/content/dj-artists/101" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                  </ScrollArea>
                </TabsContent>
                ...
                <TabsContent value="media">
                  <ScrollArea className="h-[600px] pr-4">
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X GET "${BASE_URL}/content/media-assets?entity_type=artist&limit=20" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X GET "${BASE_URL}/content/media-assets/by-entity?type=artist&id=jeff-mills" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/content/media-assets" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{
    "entity_type": "artist",
    ...
    "entity_name": "Jeff Mills"
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X POST "${BASE_URL}/content/media-assets/bulk" \\
  -H "x-api-key: td_live_xxxxx" \\
  -H "Content-Type: application/json" \\
  -d '{"action": "select_final", "asset_ids": ["uuid-1"]}'`}
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X DELETE "${BASE_URL}/content/media-assets/asset-uuid" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                  </ScrollArea>
                </TabsContent>
  ...
  "data": {
    ...
    "scopes": ["admin:full"]
                      ...
                      example={`curl -X GET "${BASE_URL}/ping" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
  ...
  "data": {
    "health": {
      ...
      "pending_reports": 2
                      ...
                      example={`curl -X GET "${BASE_URL}/system/health" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
    ...
    "analytics": {
      ...
      "by_event": {
        ...
        "click": 300
                      ...
                      example={`curl -X GET "${BASE_URL}/system/analytics" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X GET "${BASE_URL}/system/api-usage" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X GET "${BASE_URL}/system/audit" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                    ...
                    <EndpointCard
                      ...
                      example={`curl -X GET "${BASE_URL}/system/agents" \\
  -H "x-api-key: td_live_xxxxx"`}
                    />
                  </ScrollArea>
                </TabsContent>
