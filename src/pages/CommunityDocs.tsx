      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          ...
          <section className="mb-16 border border-border">
            ...
            <div className="p-6">
              <p className="font-mono text-sm text-muted-foreground mb-6">{content.moderation.description}</p>
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                {content.moderation.states.map((state) => (
          ...
          <section className="text-center p-8 border border-primary/30 bg-primary/5">
            <h2 className="font-mono text-2xl uppercase tracking-wide mb-6">{content.cta.title}</h2>
