        ...
        <main className="px-4 py-6 max-w-lg mx-auto relative z-10">
          ...
          <Card id="share-section" className="mb-8 border-logo-green/30 bg-gradient-to-br from-logo-green/10 via-transparent to-logo-green/5">
            <CardContent className="p-5">
              ...
              {/* SECONDARY ROW - White/outline buttons: X, Telegram, Facebook, Reddit, LinkedIn, Threads, Mastodon, etc. */}
              <div className="flex justify-center flex-wrap gap-1.5 mb-4">
                ...
                <Button 
                  variant="outline"
                  onClick={() => window.open(`https://www.threads.net/intent/post?text=${encodeURIComponent(`${shareText} ${shareUrl}`)}`, '_blank')}
                  className="h-8 w-8 p-0"
                  title="Threads"
                >
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                ...
                <Button 
                  variant="outline"
                  onClick={() => window.open(`https://mastodon.social/share?text=${encodeURIComponent(`${shareText} ${shareUrl}`)}`, '_blank')}
                  className="h-8 w-8 p-0"
                  title="Mastodon"
                >
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                ...
                <Button 
                  ...
                  onClick={() => {
                    navigator.clipboard.writeText(`${shareText} ${shareUrl}`);
                    toast.success("Copied! Now paste in TikTok");
                  }}
                  className="h-8 w-8 p-0"
                  title="TikTok"
                >
