        ...
        <main className="px-4 py-6 max-w-lg mx-auto relative z-10">
              ...
              {activeVariants.map((dog: any, index: number) => {
                ...
                return (
                  <div
                    ...
                    className={`flex-shrink-0 w-40 snap-center rounded-xl border p-4 transition-all cursor-pointer hover:scale-105 ${
                      currentDogIndex === index && isDogSelected
                        ? 'border-logo-green bg-logo-green/20 ring-2 ring-logo-green scale-105'
                        : isFeatured 
                  ...
                  >
                    {/* Larger Dog Image for better mobile touch */}
                    <div id={`dog-${index}`} className="flex justify-center mb-3">
                      <Dog className="w-28 h-28" animated />
                    </div>
                    ...
                    <div className="flex gap-1 justify-center" onClick={(e) => e.stopPropagation()}>
                      <Button
                        ...
                        className="h-8 px-3 font-mono text-[10px] border-logo-green/30 hover:bg-logo-green/20"
                        title="Download SVG"
                      >
          ...
          <Card id="share-section" className="mb-8 border-logo-green/30 bg-gradient-to-br from-logo-green/10 via-transparent to-logo-green/5">
            <CardContent className="p-5">
              ...
              {/* PRIMARY ROW - All share buttons with clarity */}
              <div className="grid grid-cols-4 sm:grid-cols-7 gap-2 mb-2">
                <div className="flex flex-col items-center">
                  <Button 
                    variant="outline"
                    onClick={downloadForWhatsApp}
                    className="h-12 w-12 p-0 border-border/50 text-foreground hover:bg-logo-green hover:text-background hover:border-logo-green transition-colors"
                  ...
                  <span className="text-[8px] text-muted-foreground mt-1 font-mono">📥 Sticker</span>
                </div>
                <div className="flex flex-col items-center">
                  <Button 
                    variant="outline"
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[8px] text-muted-foreground mt-1 font-mono">🔗 Open</span>
                </div>
                <div className="flex flex-col items-center">
                  <Button 
                    variant="outline"
