...
const translations: Record<string, string> = {
  ...
  'hero.tagline': 'An open-source archive and living encyclopedia of underground techno culture — artists, labels, festivals, venues, gear, and the ideas that shaped the sound.',
  'hero.description': 'Community-built. Strictly non-commercial.',
